...
void drawWaiting() {
  ...
  fill(255);
  textSize(35);
  text("Waiting for opponent", 200, height/2 + 10);
}
...
void drawPlay() {
  ...
  if (selectNew == 1) {
    fill(0, 200);
    stroke(0, 200);
    triangle(selectNewx, 50, selectNewx - 25, 100, selectNewx + 25, 100); //400, 50, 375, 100, 425, 100
    rect(selectNewx - 300, 100, 600, 100); //100, 100, 600, 100
    image(wppic, selectNewx - 300, 100, 100, 100); //100, 100, 100, 100
    image(wrpic, selectNewx - 200, 100, 100, 100); //200, 100, 100, 100
    image(wnpic, selectNewx - 100, 100, 100, 100); //300, 100, 100, 100
    image(wbpic, selectNewx, 100, 100, 100); //400, 100, 100, 100
    image(wqpic, selectNewx + 100, 100, 100, 100); //500, 100, 100, 100
    image(wKpic, selectNewx + 200, 100, 100, 100); //600, 100, 100, 100
    
    if(selectNewx + 300 >= 800) selectNewx = 450;
  }
